...
#SBATCH --job-name=smriprep_sub-03.job
#SBATCH --output=/lustre04/scratch/bpinsard/smriprep.longitudinal/code/smriprep_sub-03.out
#SBATCH --error=/lustre04/scratch/bpinsard/smriprep.longitudinal/code/smriprep_sub-03.err
...
flock --verbose /lustre03/project/rrg-pbellec/ria-beluga/alias/cneuromod.anat.smriprep.longitudinal/.datalad_lock datalad clone ria+file:///lustre03/project/rrg-pbellec/ria-beluga#~cneuromod.anat.smriprep.longitudinal $LOCAL_DATASET
cd $LOCAL_DATASET
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/smriprep_sub-03_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/smriprep_sub-03 ; fi 
