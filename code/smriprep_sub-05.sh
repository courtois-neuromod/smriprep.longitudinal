...
#SBATCH --job-name=smriprep_sub-05.job
#SBATCH --output=/lustre04/scratch/bpinsard/smriprep.longitudinal/code/smriprep_sub-05.out
#SBATCH --error=/lustre04/scratch/bpinsard/smriprep.longitudinal/code/smriprep_sub-05.err
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/smriprep_sub-05_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/smriprep_sub-05 ; fi 
